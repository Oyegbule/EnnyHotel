"""
Django settings for ENNY_HOTEL project.
...
SECRET_KEY = 'django-insecure-19_t%1+$*#v*5ri$vwg&xecn!&fm^t$w*43fr#=tm*(liwb22s'
...
WSGI_APPLICATION = 'ENNY_HOTEL.wsgi.application'
